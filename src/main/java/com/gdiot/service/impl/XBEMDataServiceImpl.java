...
import com.gdiot.mapper.XBEMDataMapper;
...
public class XBEMDataServiceImpl implements IXBEMDataService {
    ...
    @Override
    public List<XBEMDataPo> selectbySeq(String imei, String type, int flag_reload, int value) {
        List<XBEMDataPo> list = mXBEMDataMapper.selectbySeq(imei, type, flag_reload, value);
        log.info("mNBYDEMeterDataMapper selectbySeqNB list.size()=" + list.size());
        return list;
    }
