...
public class LoraSendCmds {
    ...
    public String sendMsg(String msg, String deveui, String request_id) {
        ...
        if (msg != null && msg != "" && msg.length() > 0) {
            result = sendMsgDo(msg, deveui, request_id);
        }
        return result;
    }

    private String sendMsgDo(String content, String deveui, String request_id) {
        ...
        if (content != "") {
            ...
            if (deveui != null && !deveui.equals("") && deveui.length() > 0) {
