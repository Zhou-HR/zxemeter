...
public class DXConstant {
    ...
    public static final String BASE_URL = "https://180.101.147.89:8743";//"https://device.api.ct10649.com:8743";

    //please replace the appId and secret, when you use the demo.
    public static final String APPID = "4D0s1mYvoLSz91jQb6SVpwwjyLQa";
    public static final String SECRET = "3NbkPeDAYQTcuRrChjnXmk9bQ44a";
     ...
     */
    public static final String CALLBACK_BASE_URL = "http://120.55.163.230:8081/ssm/test/";
