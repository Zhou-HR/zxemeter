...
public class YDConfig {
    ...
    private static String aeskey = "Hd4xNGlQ5fbztho2AuS1C0s8s6JcUMJMbNtV52g5qCz";//aeskey和OneNet第三方平台配置里的token一致
    ...
    //电表 千丁电表
    public static final String QD_API_KEY = "OqYhT9JtljPdMBZo4roqd34IC8mRad1OOpPZntCg7qk=";
    ...
    public static final String DH_PRODUCT_ID = "370153";
    public static final String DH_PROTOCOL = "LWM2M";
    public static final String DH_TOKEN = "gdiot8087donghua";

    //东华能源，测试环境
    public static final String YD_DEVICE_URL = "http://api.heclouds.com/devices/";
    //test  2019-07-28
    public static final String API_KEY = "csR1Lmki0NqrlC08UqF2IzqiOxY=";
    //test 2020-10-19 younenghuo
//	 public static final String API_KEY = "d2YGGNXHNnMUm=iyy4tXGYn4UJQ=";
//	 access_key ="gV/F3Ot5K0YeGuftPKowE8u7/PW9YJw2Wke7EFy9Qs8="
}
