...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo" style="width: 226px;padding: 0;text-align:center;">
            <!--<img src="images/logo_white.png?version=1.1"  style="max-height: 100%;">-->
            <div style='color:#fff;font-size:18px;margin-top:10px;margin-left:-10px;'>电表平台</div>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <c:if test="${not empty node.child}">
                            <a class="dropdown-toggle" style="width:175px;font-size:16px;" data-toggle="dropdown"
                               data-hover="dropdown"
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user" style="height:46px;">
                        <a style="height: 100%;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                                ...
                                <ul class="sub-menu">
                                    <c:forEach var="node1" items="${node.child}">
                                        <li id="${node1.companyId}" class="nav-item">
                                            <a href="${empty node1.path ? 'javascript:;' : node1.path}"
                                               class="nav-link">
