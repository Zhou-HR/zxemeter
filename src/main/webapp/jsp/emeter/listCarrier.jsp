	...
	<form class="form-inline" action="" id="search-form" style="margin-top: 15px">
    		<div class="box-search width-border">
					...
					<div class="row" style="margin-top:10px;">
							...
							<div class="search-button">
								<div class="col-md-2">
									<button type="button" class="btn btn-primary btn-sm" title="恢复基站的比例和单价默认值" onclick="restoreDefault()">
										 恢复基站的比例和单价默认值
									</button>
		            ...
		            <div class="row " name="div1" style="dispaly:block !important;margin-top:10px;">
	                        ...
	                        <div class="col-md-3">
	                            <div class="input-group">
	                                ...
	                                <input type="text" name="part" value="" data-op="contains" class="form-control input-sm" placeholder="${node.text}比例0-100"
									data-fv-notempty="true" data-fv-stringlength="true" data-fv-stringlength-max="3" data-fv-digits="true"
	                        ...
	                        <div class="col-md-3">
	                            <div class="input-group">
	                                ...
	                                <input type="text" name="price" value="100" data-op="contains" class="form-control input-sm" placeholder=""
									data-fv-notempty="true" data-fv-stringlength="true" data-fv-stringlength-max="5" data-fv-digits="true"
							...
							<div class="search-button">
								<div class="col-md-2">
									<button type="button" id='showAll1' class="btn btn-primary btn-sm" onclick="showAll()">显示所有运营商</button>
