	...
	<form class="form-inline" action="" id="search-form" style="margin-top: 15px">
    		<div class="box-search width-border">
					...
					<div class="row">
							...
							<div class="search-button">
								<div class="col-md-3">
									<button type="button" class="btn btn-primary btn-sm" title="导出电量" onclick="export1('value')">
										<i class="glyphicon glyphicon-download"></i> 导出电量
									</button>
			
									<button type="button" class="btn btn-primary btn-sm" title="导出电费" onclick="export1('fee')">
				...
				<div class="row mt25">
					<div class="col-lg-12">
						<div class="border pos-r clear-fix">
							<span class="echart-title"> <label>运营商电量</label> 
...
<script>
	...
	function export1(type){
		if(confirm("确定要导出数据吗")){
			window.location.href='export/monthCarrierValue?year='+$('#year').val()+'&month='+$('#month').val()+'&type='+type;
		}	
