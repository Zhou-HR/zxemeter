	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-md-3">
	                            <div class="input-group">
	                                ...
	                                <input type="text" id="meterNo" name="meterNo" data-op="contains" class="form-control input-sm" placeholder="表号" value="${meterNo}">
	                         ...
	                         <div class="col-md-3">
	                            <div class="input-group" style="z-index:1;">
									...
									<div class="pull-left search connect" style="width: 100px;">
										<i class="icon-inp"></i>
										<input type="text" id="date1" readonly name="date1" value="${date1}" class="form-control" value="" style="width: 100%" />
									</div>
								</div>
	                         </div>
