            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <input type="text" id="projectNo" name="projectNo" value="${projectNo}" data-op="contains"
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <input type="text" id="longitude" readonly name="longitude" value="${jd}" data-op="contains"
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <input type="text" id="latitude" readonly name="latitude" value="${wd}" data-op="contains"
                               class="form-control input-sm"
                               placeholder="纬度">
                    </div>
                </div>
