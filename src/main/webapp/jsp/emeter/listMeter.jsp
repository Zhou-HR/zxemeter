			...
			<div class="box-search width-border">
				<div class="search-default">
					...
					<div class="row" id="row">
						...
						<div class="col-md-3">
							<input type="file" id="file1" name="files" style="display:none" onchange="compress();" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet">
						</div>
		...
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
					...
					<table id="table" data-toolbar="#toolbar" data-url="meter/paging" data-method="post" data-pagination="true"
					 data-side-pagination="server" data-flat="true" data-query-params="$.getParams" data-id-field="id" data-toggle="table"
					 data-striped="true" data-show-refresh="false" data-show-toggle="false" data-show-columns="false">
						...
						<thead style='display:none'>
							<tr>
								...
								<th data-field="newValue" data-halign="left" data-align="left">新表读数</th>
                                <th data-field="oldMeterNo" data-halign="left" data-align="left">老表表号</th>
								<th data-field="oldValue" data-halign="left" data-align="left">老表读数</th>
								<th data-field="platform" data-halign="left" data-align="left">平台</th>
								<th data-field="price" data-halign="left" data-align="left">电费单价(元/度)</th>
								<th data-field="status" data-halign="left" data-formatter="show" data-align="left">状态</th>
								<th data-field="lahezhaStatus" data-halign="left" data-formatter="show1" data-align="left">拉合闸状态</th>
								<th data-field="createTime" data-halign="left" data-align="left">导入时间</th>
                                <th data-formatter="$.opFormatterDel" data-align="center">操作</th>
							</tr>
						</thead>
					</table>
				</div>
