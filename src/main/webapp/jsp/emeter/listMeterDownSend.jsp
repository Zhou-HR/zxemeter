        ...
        <div class="col-md-12">
            ...
            <table id="table"
                ...
                <tr>
                    ...
                    <th data-field="meterNo" data-halign="left" data-formatter="openclose" data-align="left">拉合闸</th>
                    <!--
                    <th data-field="meterNo" data-halign="left" data-formatter="setReportTime" data-align="left">设置上报时间</th>
                    <th data-field="meterNo" data-halign="left" data-formatter="getMeterData" data-align="left">获取电表数据</th>

                    <th data-field="meterNo" data-halign="left" data-formatter="getLostReportData" data-align="left">丢帧重传</th>
                    -->
                </tr>
                </thead>
            </table>
...
<script>
    function openclose(value, row, index) {
        var str = "<button type='button' onclick=\"downnSend('" + value + "','openclose',this);\" class='btn btn-default btn-xs' title='下发' ><span class='glyphicon glyphicon-edit'></span></button>";
        //alert(str);
        return str;
    }

    function setReportTime(value, row, index) {
        var str = "<button type='button' onclick=\"downnSend('" + value + "','SetReportTime',this);\" class='btn btn-default btn-xs' title='下发' ><span class='glyphicon glyphicon-edit'></span></button>";
        //alert(str);
        return str;
    }
    ...
    function getLostReportData(value, row, index) {
        var str = "<button type='button' onclick=\"downnSend('" + value + "','GetLostReportData',this);\" class='btn btn-default btn-xs' title='下发' ><span class='glyphicon glyphicon-edit'></span></button>";
        //alert(str);
        return str;
    }

    var edit = function (href, forward, callback) {
        dialog("下行指令", $('<div></div>').load(href + (forward == undefined ? "" : "?forward=" + forward)), callback);
    };

    function downnSend(value, type, item) {

        //item.disabled=true;
        edit('down/editDown/' + value, 'jsp/emeter/meter-' + type);
        /*
        setTimeout(function () {
            item.disabled='';
        }, 5000);*/
