...
<body>
	<form class="form-inline" action="" id="search-form" style="margin-top: 15px">
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-md-3">
	                         ...
	                         <div class="col-md-3">
	                            <div class="input-group">
	                                ...
	                                <input type="text" name="newMeterNo" data-op="contains" class="form-control input-sm" placeholder="新表号">
	                            </div>
	                         </div>
							...
							<div class="col-md-3">
	                            <div class="input-group">
	                                ...
	                                <input type="text" name="oldMeterNo" data-op="contains" class="form-control input-sm" placeholder="旧表号">
	                            </div>
	                         </div>
						...
						<div class="row">
	                        ...
	                        <div class="col-md-3">
	                            <div class="input-group">
									...
									<div >
										<select name="newBox" class="prov form-control" style="cursor:pointer;"><option value="">请选择</option><option value="1">是</option><option value="0">否</option></select> 										
								    </div>
	                            </div>
	                         </div>
							 ...
							 <div class="col-md-3">
								<div class="input-group">
									...
									<div >
										<select name="stateGrid" class="prov form-control" style="cursor:pointer;"><option value="">请选择</option><option value="1">是</option><option value="0">否</option></select> 										
								    </div>
								</div>
							</div>
		...
		<!-- 					<th data-radio="true"></th> -->
							...
							<th data-field="ifUseNewBox" data-halign="left" data-formatter="dealYesNo" data-align="left">是否新表箱</th>
							
							<th data-field="ifStateGrid" data-halign="left" data-formatter="dealYesNo" data-align="left">是否原国网表</th>
