            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <input type="text" name="deviceNo" data-op="contains" class="form-control input-sm"
                               placeholder="设备ID">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="input-group">
                        ...
                        <div>
                            <select name="platform" class="prov form-control" style="cursor:pointer;">
                                <option value="">请选择</option>
                                <option value="移动">移动</option>
                                <option value="电信">电信</option>
                                <option value="联通">联通</option>
                                <option value="国动">国动</option>
                            </select>
                        </div>
                    </div>
                </div>
