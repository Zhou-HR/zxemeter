	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-md-3">
	                            <div class="input-group">
	                                ...
	                                <input type="text" id="projectNo" name="projectNo" data-op="contains" class="form-control input-sm" placeholder="基站编号" value="">
	                         ...
	                         <div class="col-md-3">
	                            <div class="input-group" style="z-index:1;">
									...
									<div class="pull-left search connect" style="width: 100px;">
										<i class="icon-inp"></i>
										<input type="text" id="date1" name="date1" readonly value="${date1}" class="form-control" value="" style="width: 100%" />
									</div>
								</div>
	                         </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="table"
                           ...
                           data-url="stat/pagingMeterValueDay"
                           data-method="post"
