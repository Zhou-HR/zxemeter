...
<head>
    ...
    <script>
        if (IEVersion() != -1) {
            alert('IE浏览器不支持图片压缩上传，建议下载谷歌浏览器！')
        }
                    ...
                    $.ajax({
                        ...
                        success: function (data1) {
                            if (data1.success) {
                                ...
                                a.onclick = function () {
                                    window.open(data1.message, '_blank');
                                }
...
<section class="content">
    <div class="box box-primary">
        <form id="edit-form" class="form-horizontal"
              action="${empty entity? 'meter/updateMaintainResult' : 'meter/updateMaintainResult'}" method="post"
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" readonly class="form-control" name="receiverName"
                               value="${entity.receiverName}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" readonly class="form-control" id="date" name="sendDate"
                               value="${entity.sendDate}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" readonly class="form-control" name="reason" data-fv-notempty="true"
                               value="${entity.reason}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" readonly class="form-control" id="dealDate" name="dealDate"
                               value="${entity.dealDate}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <!--
							...
							-->
                        <textarea rows="3" data-fv-notempty="true" name="dealResult" maxlength="200"
                                  style="width:419px;">${entity.dealResult}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="file" id="file1" name="files" onchange="compress();"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6" id="img">
                        <c:forEach var="node" items="${list}" varStatus="status">
                            <img id='${node.id}' src='${node.path}' class='mpic'
                                 onclick="window.open(this.src,'_blank')" style="width:100px;cursor:pointer;">
