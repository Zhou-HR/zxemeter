...
<section class="content">
    <div class="box box-primary">
        <form id="edit-form" class="form-horizontal" action="${empty entity? 'down/openclose' : 'down/openclose'}"
              method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select name="optype" class="prov form-control" style="z-index:1;cursor:pointer;">
                        <option value="off">拉闸</option>
                        <option value="on">合闸</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
