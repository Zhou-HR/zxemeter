...
<head>
    ...
    <script type="text/javascript"
            src="https://webapi.amap.com/maps?v=1.4.14&key=35197568a6e6c13623a6e65acdfe249c&plugin=AMap.MarkerClusterer"></script>
    <!--解决ie Promise报错-->
...
<div class="content">
    ...
    <div id='home'>
        ...
        <div class="row mt25">
            <div class="col-md-12">
                <div class="border pos-r clear-fix">
							<span class="echart-title" style='text-align:center'> <label style='color:#0099dd'
                                                                                         onclick="window.all();">报警信息</label>
							</span>
