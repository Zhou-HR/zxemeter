...
<form id="edit-form" class="form-horizontal" action="user/setEmail" method="post"
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" id="hour" name="hour" data-op="contains" class="form-control input-sm"
                       data-fv-notempty="false" data-fv-stringlength="true" data-fv-stringlength-max="2"
                       data-fv-digits="true"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <select name="everyHour" id="everyHour" class="prov form-control" style="z-index:1;cursor:pointer;">
