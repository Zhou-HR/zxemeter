...
<html>
    ...
    <body>
        <div class="row" style="margin-top:10px;margin-left:10px;">
            ...
            <div class="col-xs-8">
                <form id="editForm" class="form-horizontal" role="form" action="permission/save" method="post" data-fv-message="This value is not valid"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <button name="icon" class="btn btn-default" data-iconset="glyphicon" data-icon="fa fa-suitcase" role="iconpicker" data-search="false"></button>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">依附于</label>
                        <div class="col-sm-6">
                            <input class="form-control" name="parentName" id="parentName" type="text" placeholder="请单击选择" readonly onclick="showMenu()">
                            <div id="menuContent" style="display: none;border: 1px solid rgba(0,0,0,.2);box-shadow: 0 5px 10px rgba(0,0,0,.2);">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select data-dict-url="dict/list/PERMISSION/TYPE" data-dict-value="${entity.type.value}" data-fv-icon="false" data-fv-notempty="true" class="form-control selectpicker" id="type" name="type" title="请选择"></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="path" class="col-sm-2 control-label">排序</label>
                        <div class="col-sm-6">
                            <input class="form-control" id="ordered" name="ordered" type="text" value="1" data-fv-notempty="true" data-fv-integer="true"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-push-3 col-sm-9">
                            ...
                            <button type="button" id="delete" onclick="doDel()" data-toggle="modal" class="btn btn-danger" style="display: none">删除</button>
                        </div>
                    </div>
                </form>
            </div>
