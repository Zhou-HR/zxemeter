    ...
    <body>
        <section class="content">
            <div class="box box-primary">
                <form class="form-horizontal" action="${empty entity? 'roleMenu/save' : 'roleMenu/edit'}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select data-dict-url="dict/list/STATUS/STATUS" data-dict-value="${entity.status.value}" id="e_status" name="status" class="form-control selectpicker" title="请选择"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="请单击选择" readonly id="checkedVal" onclick="showMenu()">
