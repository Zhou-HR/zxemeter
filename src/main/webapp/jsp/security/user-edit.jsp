                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
							...
							<c:if test="${empty entity}">
                                <input type="text" onfocus="this.type='password'" class="form-control" name="password" value="${entity.password}"
                                       data-fv-notempty="true" data-fv-stringlength="true" data-fv-stringlength-min="6">
							</c:if>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="roles" data-url="role/list1" data-text-name="description" data-value="${roleIds}" class="form-control selectpicker" multiple title="请选择"
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="menuRoles" data-url="roleMenu/list1" data-text-name="description" data-value="${roleMenuIds}" class="form-control selectpicker" multiple title="请选择"
                                        data-fv-notempty="true" data-fv-icon="false"> </select>
                            </div>
                        </div>
